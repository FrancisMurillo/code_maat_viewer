...
export const EntityOwnership = injectIntl(DataPage((props) => {
    const {intl} = props;
...
export const fetchData = createDataRequestAction(
    "ENTITY_OWNERSHIP/FETCH_ANALYSIS",
    WebService.prepareAnalysisRequest(AnalysisMethod.entityOwnership));

export const sortRecords = createDataSortAction(
    "ENTITY_OWNERSHIP/SORT_RECORDS");

export const filterRecords = createDataFilterAction(
    "ENTITY_OWNERSHIP/FILTER_RECORDS");
